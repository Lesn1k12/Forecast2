...
const menuItems = [
  { id: 1, icon: <LiaChartAreaSolid style={{ width: "24px", height: "24px" }} />, title: 'Dashboard', link: '/Dashboard' },
  { id: 2, icon: <LiaChartAreaSolid style={{ width: "24px", height: "24px" }} />, title: 'Actives', link: '/Actives' },
  { id: 3, icon: <LiaChartAreaSolid style={{ width: "24px", height: "24px" }} />, title: 'Calendar', link: '/Calendar' }
...
export default function Sidebar({ active, setActive }) {
  ...
  <nav
    ...
    {menuItems.map((item) => (
      <li
        ...
        className={`my-2 rounded-lg hover:bg-gray-100 ${active === item.id ? 'active cursor-pointer' : 'cursor-pointer'}`}
      >
  ...
  <CardFooter className={`flex justify-between absolute bottom-0 p-0 rounded-lg overflow-hidden transition-all ${expanded ? 'w-52 ml-3' : 'w-0'} `}>
