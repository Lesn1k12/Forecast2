...
const menuItems = [
  { id: 1, icon: <RxDashboard style={{ width: "24px", height: "24px" }} />, title: 'Dashboard', link: '/Dashboard' },
  { id: 2, icon: <CiMoneyBill style={{ width: "24px", height: "24px" }} />, title: 'Actives', link: '/Actives' },
  { id: 3, icon: <RxCalendar style={{ width: "24px", height: "24px" }} />, title: 'Calendar', link: '/Calendar' },
            ...
            <ul className='p-2 '>
              {menuItems.map((item) => (
                <li
                  ...
                  className={`p-1 rounded-lg hover:bg-gray-100 ${active === item.id ? 'active cursor-pointer' : 'cursor-pointer'}`}
                >
