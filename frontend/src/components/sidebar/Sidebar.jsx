...
export default function Sidebar({ active, setActive }) {
  ...
  return (
    <ContextProvider>
      <Card className="relative h-full flex flex-col justify-between xs:w-xs sm:w-sm hidden md:w-md hidden lg:w-lg xl:w-xl 2xl:w-2xl 3xl:w-3xl  lg:block xl:block 2xl:block 3xl:block">
